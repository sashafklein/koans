...
class AboutIteration < EdgeCase::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Extra Credit:
    # It accepts an argument which becomes the first item in the block, 
    # then performs the method on it using each element in the array 
    # as the second, and saving that first element between executions.
  end
  ...
  # To limit the scope of the variables 'file' and 'line'?
